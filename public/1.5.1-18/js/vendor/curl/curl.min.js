...
U&&!W()&&(ra=[$(this,"load"),$(U,"readystatechange"),$(this,"DOMContentLoaded")],Z=setTimeout(ua,va));define("curl/domReady",function(){function a(a){Y?a():ta.push(a)}a.then=a;a.amd=h;return a});define("curl/plugin/domReady",["../domReady"],function(a){return{load:function(b,d,c){a(c)}}});var wa=this.document;function xa(a){try{return eval(a)}catch(b){}}
...
r]),fa&&(a.I="text/cache",b(a,function(a){a&&a.parentNode.removeChild(a)},function(){}),a.I="")):(i=i||s,d(a,r)))}}});
}).call(this);